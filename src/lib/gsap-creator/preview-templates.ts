...
export const PREVIEW_TEMPLATES: PreviewTemplate[] = [
  ...
  <h1 class="heading element" style="font-size:3rem;font-weight:700;color:inherit;font-family:inherit;line-height:1.1;">
  ...
  <h2 class="heading element" style="font-size:2.5rem;font-weight:700;color:inherit;line-height:1.1;">
    Hero Heading
  </h2>
  <p class="paragraph element" style="font-size:1.125rem;color:inherit;opacity:0.7;line-height:1.6;text-align:center;">
  ...
  },
  {
    ...
    html: `<div class="preview-container" style="display:flex;align-items:center;justify-content:center;height:100%;padding:2rem;">
  <div class="card element" style="padding:2rem;border-radius:1rem;border:1px solid rgba(128,128,128,0.2);background:rgba(128,128,128,0.05);max-width:400px;width:100%;">
  ...
  <div class="card element" style="padding:1.5rem;border-radius:0.75rem;border:1px solid rgba(128,128,128,0.2);background:rgba(128,128,128,0.05);">
  ...
  <span class="badge element" style="display:inline-block;padding:0.25rem 0.75rem;border-radius:9999px;font-size:0.75rem;font-weight:500;background:rgba(14,165,233,0.1);color:rgba(14,165,233,1);">New Feature</span>
  <h1 class="heading element" style="font-size:3rem;font-weight:800;color:inherit;line-height:1.05;max-width:700px;">
    Build Something Amazing
  </h1>
  <p class="paragraph element" style="font-size:1.125rem;color:inherit;opacity:0.6;max-width:500px;line-height:1.6;">
    Create stunning animations with an intuitive visual timeline editor.
  </p>
  <div class="buttons element" style="display:flex;gap:0.75rem;margin-top:0.5rem;">
  ...
  <div class="list-item element" style="display:flex;align-items:center;gap:1rem;padding:1rem;border-radius:0.5rem;border:1px solid rgba(128,128,128,0.15);background:rgba(128,128,128,0.03);">
