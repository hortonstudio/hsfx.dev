...
export function PreviewArea({ config, playback, onPlaybackChange, playheadRef }: PreviewAreaProps) {
  ...
  const buildTimeline = useCallback(() => {
    ...
    for (const tween of config.tweens) {
      const target = sandboxRef.current.querySelectorAll(tween.target);
